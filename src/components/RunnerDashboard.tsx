  ...
  return (
    <div className="glass-panel p-5 space-y-4">
      ...
      <div ref={bibRef} className="relative w-full aspect-[3/2] overflow-hidden rounded-xl bg-[var(--surface-inset)] select-none" style={{ containerType: 'inline-size' }}>
        ...
        <span className="absolute -translate-x-1/2 -translate-y-1/2 leading-none font-black font-mono tracking-tight drop-shadow-[0_2px_2px_rgba(0,0,0,0.9)]" style={{ left: `${layout.bibNumberX}%`, top: `${layout.bibNumberY}%`, fontSize: `${layout.bibNumberSize ?? 12}cqw`, color: layout.bibNumberColor ?? '#FFFFFF' }}>{runnerProfile.bibNumber}</span>
